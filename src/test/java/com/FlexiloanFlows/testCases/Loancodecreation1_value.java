...
public class Loancodecreation1_value extends BaseClass{
	...
	public void openLoancreatio() throws Exception {
		...
		loancodeselect.selectByIndex(0);
...
//			System.out.println(mob1.getText());       
		...
		public void FormOne1() throws Exception{
			...
			f1.MonthalySalesField(b);  //"b"  For AA flow
...
//			System.out.println(ms.getAttribute("value"));
			...
			System.out.println("Monthly Sale :- "+text);
			
			
			dynamicWait(10, f1.GstY); 
			f1.GstYES();
			
			dynamicWait(10, f1.loancreationform1ctnbutton);
			f1.LoanCreationForm1ContinueButton();	
...
//				System.exit(0);
			...
			System.out.println("Else not run if monthly sale in greater than 2 lac");
				System.out.println("START EXAAA");
			}
...
//			scroll5.sendKeys(Keys.PAGE_DOWN);
			...
			Thread.sleep(120000);   //Not change this Sleep
		} 
		...
		public void FormThree3() throws Exception{
			...
			Thread.sleep(13000); 		 //Not change this Sleep
